...
namespace PlannyCore.Models
{
    ...
    {  /// <summary>
       ...
       /// </summary>
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static ApiResponse<T> ErrorResult(string message = "", ApiResponseCodeEnum? code = null , HttpStatusCode statusCode = HttpStatusCode.InternalServerError, T data = default(T))
        {
            return new ApiResponse<T>
            {
